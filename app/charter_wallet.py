...
def apple_wallet_pass(*, flight_id: str, passenger: dict, flight_no: str, dep: str, ades: str, gate: str, departure: str) -> bytes:
    ...
    with tempfile.TemporaryDirectory() as directory:
        ...
        # Apple renders its own aircraft icon between the two primary fields.
        # Keeping the airports separate prevents that icon from covering a
        # hand-written arrow or either airport code.
        fields["primaryFields"] = [
            {"key": "origin", "label": "FROM", "value": dep},
            {"key": "destination", "label": "TO", "value": ades},
        ]
